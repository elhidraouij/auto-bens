...
const Header = () => {
  ...
  return (
    <header
      className={"transition duration-500 bg-zinc-950 fixed top-0 z-50 w-full " + opacity}
    >
      <div className="flex flex-col justify-center items-stretch">
        ...
        <nav className="flex flex-row justify-center text-white text-xl tracking-tighter italic">
