...
const Pagination = ({
  ...
  <ul className="flex items-center -space-x-px h-10 text-base">
    ...
    <li>
      <a href="#" aria-current="page" className="z-10 flex items-center justify-center px-4 h-10 leading-tight text-yellow-600 border border-yellow-300 bg-yellow-50 hover:bg-yellow-100 hover:text-yellow-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
    </li>
    <li>
