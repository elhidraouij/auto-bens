    ...
    totalPage > 0 && (
      <nav aria-label="Page navigation example">
        <ul className="flex items-center -space-x-px h-10 text-base">
          ...
          {previousPages.map((i) => {
            ...
            return (
              <li key={i} onClick={() => {setPage(i)}}>
                <span className="cursor-pointer flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                  {i}
                </span>
              </li>
            );
          ...
          <li>
            <span
              className={`cursor-pointer  z-10 flex items-center justify-center px-4 h-10 leading-tight text-yellow-600 border border-yellow-300 bg-yellow-50 hover:bg-yellow-100 hover:text-yellow-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white ${
                page == 1 && "rounded-l-lg"
